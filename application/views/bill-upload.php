        ...
        <div class="card-body">
          <div class="row">
          	<div class="offset-sm-1 col-10">
          		<h5 class="text-warning" id="page-heading">Meter data-e	ntry</h5>
          		<hr/>
          		<form name="f1" method="POST" action="<?php echo base_url();?>Bill-upload">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col row">
                            <label for="inputEmail3" class="col-sm-4 col-form-label text-xs">Current Reading Date<label class="text-danger">*</label></label>
                            <div class="col-sm-8">
